...
const PAGE_FAQS: Record<string, { q: string; a: string }[]> = {
  ...
  "/hadith/sahih-bukhari/bangla": [
    { q: "সহীহ বুখারী বাংলা হাদিস কি Noor অ্যাপে পড়া যায়?", a: "হ্যাঁ, Noor অ্যাপে সহীহ বুখারীর হাদিস আরবি টেক্সট ও বাংলা অনুবাদ সহ বিনামূল্যে পড়া যায়। সংকলনটি গ্রন্থ ও অধ্যায় অনুযায়ী সাজানো।" },
    { q: "Sahih Bukhari Bangla translation কি বিশ্বস্ত?", a: "হ্যাঁ, Noor অ্যাপের বাংলা অনুবাদ বিশ্বস্ত ও নির্ভরযোগ্য উৎস থেকে সংগৃহীত।" },
    { q: "সহীহ বুখারীতে কতটি অধ্যায় আছে?", a: "সহীহ বুখারীর অধ্যায়গুলো ঈমান, নামাজ, রোজা ও অন্যান্য বিষয় অনুযায়ী সাজানো; সংস্করণভেদে গণনা ভিন্ন হতে পারে।" },
  ...
  "/hadith/sahih-bukhari/urdu": [
    { q: "کیا Noor ایپ پر صحیح بخاری اردو میں پڑھ سکتے ہیں؟", a: "جی ہاں، Noor ایپ پر صحیح بخاری کی احادیث عربی متن اور اردو ترجمے کے ساتھ مفت دستیاب ہیں، اور کتاب و باب کے لحاظ سے ترتیب دی گئی ہیں۔" },
    { q: "صحیح بخاری میں کتنے ابواب ہیں؟", a: "صحیح بخاری کے ابواب ایمان، نماز، روزہ اور دیگر موضوعات کے مطابق ترتیب دیے گئے ہیں؛ شمار ایڈیشن کے لحاظ سے مختلف ہو سکتا ہے۔" },
  ...
  "/hadith/sahih-bukhari": [
    { q: "What is Sahih al-Bukhari?", a: "Sahih al-Bukhari is a major Hadith collection compiled by Imam Muhammad ibn Ismail al-Bukhari (810–870 CE). Noor presents it with book and chapter navigation; numbering can vary by edition." },
    { q: "How many hadiths are in Sahih Bukhari?", a: "Sahih al-Bukhari was compiled using strict criteria of authenticity; the displayed numbering may vary by edition." },
